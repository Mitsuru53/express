  ...
  <v-app id="inspire">
    ...
    <v-toolbar color="indigo" dark fixed app>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat :to="{ name: 'Register' }" v-if="!current_user" id="register_btn">
          Register
        </v-btn>
        <v-btn flat :to="{ name: 'Login' }" v-if="!current_user" id="login_btn">
          Login
        </v-btn>
        <v-btn flat v-if="current_user" id="logout_btn" @click="logout">
          Logout
        </v-btn>
      </v-toolbar-items>
    </v-toolbar>
